...
export declare class CohereClientV2 implements Omit<CohereClient, "chat" | "chatStream" | "v2">, Pick<V2, keyof V2> {
    private _options;
    constructor(_options: CohereClient.Options);
    private client;
    private clientV2;
    chat: (request: import("./api").V2ChatRequest, requestOptions?: V2.RequestOptions | undefined) => Promise<import("./api").NonStreamedChatResponse2>;
    chatStream: (request: import("./api").V2ChatStreamRequest, requestOptions?: V2.RequestOptions | undefined) => Promise<import("./core").Stream<import("./api").StreamedChatResponse2>>;
    ...
    embed: (request?: import("./api").EmbedRequest, requestOptions?: CohereClient.RequestOptions | undefined) => Promise<import("./api").EmbedResponse>;
    rerank: (request: import("./api").RerankRequest, requestOptions?: CohereClient.RequestOptions | undefined) => Promise<import("./api").RerankResponse>;
